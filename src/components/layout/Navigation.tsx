...
const DEFAULT_NAVBAR = {
  ...
  signInHref: '/signin',
  getStartedButton: 'Book Now',
  getStartedHref: '/booking',
} as const;
  ...
  return (
    <nav
      ...
      className={cn(
        ...
        !config.isTransparent && 'border-b bg-background/95 backdrop-blur-md shadow-sm',
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center space-x-2">
              <div className="size-8 rounded-lg bg-gradient-to-br from-primary to-destructive flex items-center justify-center shadow-md">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Button
              size="sm"
              className={cn(
                'group bg-gradient-to-r from-primary to-destructive hover:from-primary/90 hover:to-destructive/90 shadow-md',
                config.isTransparent &&
                  !isScrolled &&
                  config.lightText &&
        ...
        >
          ...
          >
            ...
            <div className="pt-4 flex flex-col space-y-2">
              ...
              <Button
                className={cn(
                  'justify-start group bg-gradient-to-r from-primary to-destructive hover:from-primary/90 hover:to-destructive/90',
                  config.isTransparent &&
                    !isScrolled &&
                    config.lightText &&
                    'bg-white text-black hover:bg-white/90'
