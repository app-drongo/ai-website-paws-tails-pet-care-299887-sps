...
const DEFAULT_CONTACT = {
  badge: 'Contact PawPerfect',
  mainTitle: "Let's Talk About Your",
  mainTitleHighlight: "Pet's Needs",
  mainDescription:
    "Ready to give your furry friend the best care? We'd love to discuss how we can help with grooming, boarding, training, and wellness services.",
  formTitle: 'Schedule a Consultation',
  formDescription:
    "Tell us about your pet and we'll create a personalized care plan within 24 hours.",
  submitButton: 'Send Message',
  contactSectionTitle: 'Get in Touch',
  method1Title: 'Email Us',
  method1Description: 'Quick questions & bookings',
  method1Contact: 'hello@pawperfect.com',
  method2Title: 'Call Us',
  method2Description: 'Speak with our pet experts',
  method2Contact: '+1 (555) PAW-CARE',
  method3Title: 'Live Chat',
  method3Description: 'Instant pet care support',
  method3Contact: 'Available 7 days a week',
  officesSectionTitle: 'Our Locations',
  office1City: 'Downtown Center',
  office1Address: '123 Pet Paradise Ave, Suite 100',
  office1Timezone: 'Main Location',
  office2City: 'Westside Branch',
  office2Address: '456 Doggy Lane, Building B',
  office2Timezone: 'Full Services',
  office3City: 'Mobile Services',
  office3Address: 'We come to you anywhere in the city',
  office3Timezone: 'By Appointment',
  hoursTitle: 'Service Hours',
  hoursWeekdayLabel: 'Monday - Friday',
  hoursWeekdayTime: '7:00 AM - 7:00 PM',
  hoursSaturdayLabel: 'Saturday',
  hoursSaturdayTime: '8:00 AM - 6:00 PM',
  hoursSundayLabel: 'Sunday',
  hoursSundayTime: '9:00 AM - 5:00 PM',
  supportNote: 'Emergency pet care support available 24/7 for boarding guests',
  nameLabel: 'Pet Parent Name *',
  namePlaceholder: 'Your Name',
  emailLabel: 'Email Address *',
  emailPlaceholder: 'your.email@example.com',
  companyLabel: "Pet's Name (Optional)",
  companyPlaceholder: 'Buddy, Luna, Max...',
  messageLabel: 'Tell Us About Your Pet *',
  messagePlaceholder:
    "What services are you interested in? Tell us about your pet's breed, age, temperament, and any special needs...",
} as const;
...
export default function Contact(props: ContactProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Pet care consultation request:', formData);
  };
  ...
  return (
    <section
      id="contact"
      className="py-24 bg-gradient-to-b from-destructive/5 via-muted/10 to-background"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
          {/* Contact Form */}
          <Card className="border-border/50 shadow-lg shadow-destructive/5">
            <CardHeader className="bg-gradient-to-r from-destructive/5 to-primary/5 rounded-t-lg">
              <CardTitle className="text-2xl flex items-center gap-2">
                <Send className="size-6 text-destructive" />
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 border border-border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-destructive/20 focus:border-destructive transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 border border-border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-destructive/20 focus:border-destructive transition-colors resize-none"
                ...
                <Button
                  type="submit"
                  className="w-full text-base py-6 group bg-gradient-to-r from-destructive to-destructive/90 hover:from-destructive/90 hover:to-destructive shadow-lg"
                >
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-semibold flex items-center gap-2">
                <Headphones className="size-5 text-destructive" />
              ...
              <div className="grid gap-4">
                {contactMethods.map((method, index) => {
                  ...
                  return (
                    <Card
                      key={index}
                      className="border-border/50 hover:border-destructive/30 transition-colors cursor-pointer group shadow-md hover:shadow-lg hover:shadow-destructive/10"
                    >
                      <CardContent className="p-6">
                        <div className="flex items-start gap-4">
                          <div className="size-12 rounded-lg bg-gradient-to-br from-destructive/10 to-primary/10 flex items-center justify-center group-hover:from-destructive/20 group-hover:to-primary/20 transition-colors">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {offices.map((office, index) => (
                  <div
                    key={index}
                    className="p-4 border border-border/50 rounded-lg bg-gradient-to-r from-card to-muted/20 shadow-sm"
                  >
                    <div className="flex items-start justify-between">
                      <div>
                        <h4 className="font-semibold flex items-center gap-2">
                          <PawPrint className="size-4 text-destructive" />
            ...
            <Card className="border-border/50 shadow-lg shadow-destructive/5">
              <CardContent className="p-6">
                ...
                <div className="mt-4 p-3 bg-gradient-to-r from-destructive/10 to-primary/10 rounded-lg border border-destructive/20">
